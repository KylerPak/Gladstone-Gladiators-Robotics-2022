...
public class DriveStraightCommand extends SequentialCommandGroup {
  ...
  public DriveStraightCommand(DrivetrainSubsystem m_driveTrain, ArmSubsystem m_armSubsystem, LimelightSubsystem m_limelight, BallShooterSubsystem m_shooterSubsystem, FeedMotorSubsystem m_feedSystem) {
   ...
   /* PathPlannerTrajectory driveBackwardsPath = new PathPlanner.loadPath("Drive BackWards", Constants.kMaxSpeedMetersPerSecond, Constants.kMaxAccelerationMetersPerSecondSquared);
...
*/
    ...
    addCommands(
      ...
      new BallShooterCommand(m_shooterSubsystem, m_feedSystem).withTimeout(3.5)
    );
  }
}
